...
async def modules(call: CallbackQuery):
    ...
    inline_kb_list.append([IButton(text="🌐Подробнее", url="https://vubni.gitbook.io/jarvis/besplatnaya-versiya/unikalnye-vozmozhnosti/oblako")])
    inline_kb_list.append([IButton(text="«", callback_data="commands")])
    await message.edit_text("<b>☁️Облако позволяет сохранять сообщения/фото/видео/файлы <u>навсегда</u>!</b>", reply_markup=IMarkup(inline_keyboard=inline_kb_list))
