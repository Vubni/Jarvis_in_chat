...
async def modules(call: CallbackQuery):
    ...
    inline_kb_list.append([IButton(text="🌐Подробнее", url="https://vubni.gitbook.io/jarvis/besplatnaya-versiya/unikalnye-vozmozhnosti/umnyi-dom")])
    inline_kb_list.append([IButton(text="«", callback_data="commands")])
    await message.edit_text("<b>🏡Умный дом позволяет управлять умным домом из любого чата Telegram!</b>", reply_markup=IMarkup(inline_keyboard=inline_kb_list))
